...
--
-- Name: seq_red_pyme; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.seq_red_pyme
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.seq_red_pyme OWNER TO postgres;
...
--
-- Name: seq_tipo_red; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.seq_tipo_red
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.seq_tipo_red OWNER TO postgres;
...
--
-- Name: tbl_red_pyme; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tbl_red_pyme (
    id_red_pyme integer DEFAULT nextval('public.seq_red_pyme'::regclass) NOT NULL,
    id_pyme integer NOT NULL,
...
ALTER TABLE public.tbl_red_pyme OWNER TO postgres;
...
--
-- Name: tbl_tipo_red_social; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tbl_tipo_red_social (
    id_tipo_red integer DEFAULT nextval('public.seq_tipo_red'::regclass) NOT NULL,
    nom_red_social character varying(50) NOT NULL
);


ALTER TABLE public.tbl_tipo_red_social OWNER TO postgres;
...
--
-- Data for Name: tbl_red_pyme; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: tbl_tipo_red_social; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tbl_tipo_red_social (id_tipo_red, nom_red_social) FROM stdin;
1	Whatsapp
2	Facebook
3	Instagram
\.
...
--
-- Name: seq_tipo_red; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.seq_tipo_red', 3, true);
...
SELECT pg_catalog.setval('public.tbl_sub_servicio_id_sub_servicio_seq', 19, true);
...
--
-- Name: tbl_red_pyme pk_red_pyme; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_red_pyme
    ADD CONSTRAINT pk_red_pyme PRIMARY KEY (id_red_pyme);
...
--
-- Name: tbl_tipo_red_social pk_tipo_red_social; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_tipo_red_social
    ADD CONSTRAINT pk_tipo_red_social PRIMARY KEY (id_tipo_red);
...
--
-- Name: idx_red_pyme; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_red_pyme ON public.tbl_red_pyme USING btree (id_tipo_red);
...
--
-- Name: idx_tipo_red_social; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_tipo_red_social ON public.tbl_tipo_red_social USING btree (id_tipo_red);
...
--
-- Name: tbl_red_pyme fk_red_pyme_pyme; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_red_pyme
    ADD CONSTRAINT fk_red_pyme_pyme FOREIGN KEY (id_pyme) REFERENCES public.tbl_pyme(id_pyme);


--
-- Name: tbl_red_pyme fk_red_pyme_tipo_red; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_red_pyme
    ADD CONSTRAINT fk_red_pyme_tipo_red FOREIGN KEY (id_tipo_red) REFERENCES public.tbl_tipo_red_social(id_tipo_red);
