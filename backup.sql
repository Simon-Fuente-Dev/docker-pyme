...
\restrict D6NqgDuFaHqaDJf0IdGHdyXwefAYd6rRyq6Q5zzB3j03fgI26NDoAYAugi3KhCt
...
SELECT pg_catalog.setval('public.pyme_id_pyme_seq', 1, true);
...
SELECT pg_catalog.setval('public.tbl_sub_servicio_id_sub_servicio_seq', 3, true);
...
SELECT pg_catalog.setval('public.tbl_tipo_serv_pyme_id_serv_pyme_seq', 1, false);
...
SELECT pg_catalog.setval('public.tbl_tipo_servicio_id_tipo_servicio_seq', 3, true);
...
SELECT pg_catalog.setval('public.tbl_usuario_pyme_id_usu_pyme_seq', 1, true);
...
\unrestrict D6NqgDuFaHqaDJf0IdGHdyXwefAYd6rRyq6Q5zzB3j03fgI26NDoAYAugi3KhCt
